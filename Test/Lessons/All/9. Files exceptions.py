...
#
#
# Путь не указан потому что файл находится в каталоге с исполнительным файлом
f = open('1.txt', 'w')
f.write('hello file')
f.close
# Чтение
...
print(f.read())
f.close
# Для того чтобы не закрывать файл и не проебывать есть конструкция with
# которая делает все сама
...
# print(a/b)
# Здесть стандартное деление, но если мы поделим на 0 будет ошибка,
# поєтому есть исключение.
try:
    a = int(input('Введите число А '))
    b = int(input('Введите число Б '))
    print(a / b)
