# Питон это обьектно ориентированный язык программирования - парадигма
# основанная на представлении прогр в виде совокупн обьектов являющихся
...
class House():  # Супер КЛАСС (Родитель)
    ...
    def build(self):  # Экземпляр класса
        '''Build a house'''
        print('House on street ' + self.street + 'on number ' +
              str(self.number) + ' already build.')
...
# Наследует все но может иметь свои особенности. или переопределять
# существующие.
