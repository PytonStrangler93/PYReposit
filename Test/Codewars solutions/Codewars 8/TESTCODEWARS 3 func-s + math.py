...
def basic_op(op, v1, v2):
    return v1 + v2 if op == "+" else v1 - \
        v2 if op == "-" else v1 * v2 if op == "*" else v1 / v2
...
def basic_op(o, v1, v2): return __import__("operator").__dict__[
    {"+": "add", "-": "sub", "*": "mul", "/": "truediv"}[o]](v1, v2)


def basic_op(o, v1, v2): return eval("{}{}{}".format(v1, o, v2))
